...
import com.ejTrading.data.SymbolLoader;
import com.ejTrading.data.TDPositionsExcelImport;
import com.ejTrading.data.YahooMarketDataClient;
import com.ejTrading.data.levTradingMongoClient;
import com.ejTrading.factory.InstrumentFactory;
import com.ejTrading.legacyAuth.ApiException;
import com.ejTrading.model.ClosedPosition;
import com.ejTrading.model.Instrument;
import com.ejTrading.model.InstrumentPrice;
import com.ejTrading.model.OptionExpirationDate;
import com.ejTrading.model.OptionRequest;
import com.ejTrading.model.ProcessedSymbols;
import com.ejTrading.model.RDRFilterResult;
import com.ejTrading.model.Symbol;
import com.ejTrading.model.constants;
import com.ejTrading.parser.ShortInterestHTMLParser;
import com.ejTrading.reporting.RDRTextReport;
import com.ejTrading.terminalControllers.ChartingController;
import com.ejTrading.terminalControllers.PositionsAndReportingController;
import com.ejTrading.tradingStrategy.RDRDeterminer;
import com.ejTrading.tradingStrategy.ReturnCalculator;
...
public class ETClientApp extends AppCommandLine {
    ...
    public void keyMenu(ETClientApp obj) throws NumberFormatException, IOException {
        ...
        do {
            ...
            switch (choice) {
                ...
                case 4: 
                	positionsAndReportingMenu(this);
    ...
    public void positionsAndReportingMenu(ETClientApp obj)  throws NumberFormatException, IOException {
		int choice = 0;
		String symbol = "";
		do {

			PrintPositionsAndReporting();
			choice = KeyIn.getKeyInInteger();
			switch (choice) {

				case 1: 
					new PositionsAndReportingController().executeLoadPositions();
					break;
				case 2: 
					new PositionsAndReportingController().printPositionsForRange();
					break;
				case 3: 
					new PositionsAndReportingController().createPositionsForRangeCSV(null);
					break;
					
				case 4: 
					new PositionsAndReportingController().createSymbolAnalysisReport(null);
					break;
					
				case 5:
					new PositionsAndReportingController().createAllReports();
					break;
    ...
    public void chartingMenu(ETClientApp obj)  throws NumberFormatException, IOException {
		int choice = 0;
		String symbol = "";
		do {
			...
			switch (choice) {
				...
				case 1: 
					new ChartingController().runRDR(false);
					break;
				case 2: 
					new ChartingController().createShortInterestChartingReport();
					break;
				case 3: 
					new ChartingController().runDeltaBetweenAlgoSourceAndTDMaster();
					break;
					
				case 4: 
					new ChartingController().generateTDMasterListFromChartList();
					break;
					
				case 5: 
					new ChartingController().runTDToTradeviewProcess();
					break;
					
				case 6: 
					new ChartingController().runTradeViewToTDProcess();
					break;
					
				case 7: 
					new ChartingController().createPercentUpReportFromWatchList();
					break;
				case 10:
	                out.println("Back to previous menu");
	                keyMenu(this);
	...
	private void runCalcReturns(){
		//System.out.print("Hit it");
		 
		ReturnCalculator calc = new ReturnCalculator();
		...
		while(maxRate<=1){
			...
			maxRate = lossRate *2; 
			double result = calc.computeReturn(100, lossRate, maxRate, 10);
			System.out.println("Min: "  + lossRate + " Max: " + maxRate +  " Return: " + result);
			lossRate+=.05; 		
		}
	}
