...
public class ApiResource {
	...
	private String optionsExpiryUri;
	
	
	public String getOptionsExpiryUri() {
		return optionsExpiryUri;
	}

	public void setOptionsExpiryUri(String optionsExpiryUri) {
		this.optionsExpiryUri = optionsExpiryUri;
	}

	public String getOptionsChainURi() {
		return optionsChainURi;
	}

	public void setOptionsChainURi(String optionsChainURi) {
		this.optionsChainURi = optionsChainURi;
	}
